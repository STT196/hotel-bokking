...
<body>
    ...
    <!-- main body start -->
    <div id="main-wrapper " class="p-0s">
        <!-- counterOne section start -->
        <div class="counterOne ptb-100">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-12 col-sm-12">
                        <div class="our-progress">
                            ...
                            <p>Aliquet elit nulla sed massa. Ut cursus massa urnaaculis estieed.</p>
                        </div>
                        <!-- /.our-progress -->
                    </div>
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12">
                        <div class="our-progress">
                            ...
                            <h4><a href="#">Wev Development</a></h4>
                            <p>Aliquet elit nulla sed massa. Ut cursus massa urnaaculis estieed.</p>
                        </div>
                        <!-- /.our-progress -->
                    </div>
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12">
                        <div class="our-progress">
                            <div class="chart_one" data-percent="39">
        ...
        <!-- /.counterOne section end -->

        <!-- counterTwo section start -->
        <div class="counterTwo ptb-100">
            <div class="container text-center">
                <div class="row">
                    <div class="col-lg-3 col-md-12 col-sm-12">
                        <div class="our-progress">
                            <div class="chart_two_1st" data-percent="50">
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12">
                        <div class="our-progress">
                            <div class="chart_two_2nd" data-percent="75">
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12">
                        <div class="our-progress">
                            <div class="chart_two_3rd" data-percent="27">
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12">
                        <div class="our-progress">
                            <div class="chart_two_4th" data-percent="63">
                                <span class="percent">63</span>
                            </div>
                            <h4><a href="#">Woocommerce</a></h4>
                            <p>Aliquet elit nulla sed massa. Ut cursus massa urnaaculis estieed.</p>
                        </div>
                        <!-- /.our-progress -->
                    </div>
        ...
        <!-- /.counterTwo section end -->


        <!-- counterThree section start -->
        <div class="counterThree ptb-100">
            <div class="container text-center">
                <div class="row">
                    <div class="col-lg-3 col-md-12 col-sm-12">
                        <div class="our-progress">
                            <div class="chart_three_1st" data-percent="32">
                                <span class="percent percent-one">32</span>
                            </div>
                            <h4><a href="#">Photoshop</a></h4>
                            <p>Aliquet elit nulla sed massa. Ut cursus massa urnaaculis estieed.</p>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12">
                        <div class="our-progress">
                            <div class="chart_three_2nd" data-percent="50">
                                <span class="percent percent-two">50</span>
                            </div>
                            <h4><a href="#">Javascript</a></h4>
                            <p>Aliquet elit nulla sed massa. Ut cursus massa urnaaculis estieed.</p>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12">
                        <div class="our-progress">
                            <div class="chart_three_3rd" data-percent="76">
                                <span class="percent percent-three">76</span>
                            </div>
                            <h4><a href="#">Android</a></h4>
                            <p>Aliquet elit nulla sed massa. Ut cursus massa urnaaculis estieed.</p>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12">
                        <div class="our-progress">
                            <div class="chart_three_4th" data-percent="15">
                                <span class="percent percent-four">15</span>
                            </div>
                            <h4><a href="#">Woocommerce</a></h4>
                            <p>Aliquet elit nulla sed massa. Ut cursus massa urnaaculis estieed.</p>
                        </div>
            ...
            <div class="container text-center">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12">
                        ...
                        <h4><a href="#">Projects Completed</a></h4>
                        <div class="count-description">
                            <span class="timer">785</span>
                        </div>
                    </div>


                    <div class="col-lg-3 col-md-3 col-sm-12">
                        <span class="icon-two"><i class="fa fa-coffee"></i></span>
                        <h4><a href="#">Coffees Consumed</a></h4>
                        <div class="count-description">
                            <span class="timer">785</span>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12">
                        <span class="icon-four"><i class="fa fa-cog"></i></span>
                        <h4><a href="#">Lines of Code</a></h4>
                        <div class="count-description">
                            <span class="timer">785</span>
                        </div>
                    </div>
        ...
        <!-- counterFive section start -->
        <div class="counterFive ptb-100">
            <div class="container text-center">
                <div class="row">
                    <div class="col-lg-3 col-md-12 col-sm-12">
                        <div class="our-progress-one">
                            <h2><a href="#">Website Design</a></h2>
                            <div class="chart_five_1st" data-percent="90">
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12">
                        <div class="our-progress-two">
                            <h2><a href="#">Mobile Application</a></h2>
                            <div class="chart_five_2nd" data-percent="63">
                                <span class="percent">63</span>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12">
                        <div class="our-progress-three">
                            <h2><a href="#">Corporate Identity</a></h2>
                            <div class="chart_five_3rd" data-percent="32">
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12">
                        <div class="our-progress-four">
                            <h2><a href="#">Graphic Design</a></h2>
                            <div class="chart_five_4th" data-percent="51">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="sb-footer-logo">
                        ...
                        <p><a href="javascript:;"><span><i class="fas fa-phone-alt"></i></span> &nbsp; Toll free
                                <br>
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;808 111 9999</a></p>
                    </div>
                </div>
    ...
    <script>
        ...
        $('.counterThree').bind('inview', function (event, visible, visiblePartX, visiblePartY) {
            if (visible) {
        ...
        // Counter (Chart)
        // -------------------------------------------------------------
        $('.counterFive').bind('inview', function (event, visible, visiblePartX, visiblePartY) {
            if (visible) {
